...
public class MakananAdapter extends RecyclerView.Adapter<MakananAdapter.MakananViewHolder> {String data1[], data2[], data3[];
    int images[];
    Context context;
    ...
    public void onBindViewHolder(@NonNull
                                         MakananViewHolder holder, int position) {
