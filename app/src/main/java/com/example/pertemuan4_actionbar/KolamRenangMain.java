...
import com.example.pertemuan4_actionbar.databinding.KolamRenangBinding;
...
public class KolamRenangMain extends AppCompatActivity {
    ...
    private KolamRenangBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = KolamRenangBinding.inflate(getLayoutInflater());
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Long rec = sqLiteDatabase.insert("daftar_kolam", null, cv);
                if (rec != null) {
                    Toast.makeText(KolamRenangMain.this, "Data  Inserted", Toast.LENGTH_SHORT).show(); binding.edtname.setText("");

                    binding.edtimage.setImageResource(R.mipmap.ic_launcher);
                    binding.edtstar.setText("");
                    binding.edtprice.setText("");
                } else {
                    Toast.makeText(KolamRenangMain.this, "Something  Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(KolamRenangMain.this, DisplayData.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (recedit != -1) {
                    Toast.makeText(KolamRenangMain.this, "Update  Succesfully", Toast.LENGTH_SHORT).show();
                            //clear data adfte submit
                            binding.edtname.setText(""); binding.edtstar.setText("");
                    binding.edtprice.setText("");
                    ...
                    Intent a = new Intent(KolamRenangMain.this, DisplayData.class);
                    startActivity(a);
                }
            }
        });
